...
This is a minimal terraform module for implementing a Google Cloud Bucket. It can either be used as a standalone module or within a bigger project using terragrunt, example:

*terragrunt.hcl*
```hcl
source = "git@github.com:ranson21/tf-gcp-bucket"
